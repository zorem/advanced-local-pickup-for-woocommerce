	...
	public function wclp_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		$wp_customize->add_control( new WPLP_Skyrocket_Dropdown_Select_Custom_Control( $wp_customize, 'wclp_ready_pickup_preview_order_id',
			array(
				'label' => __( 'Preview order', 'advanced-local-pickup-pro' ),
				'description' => '',
				'section' => 'customer_email_notifications',
				'input_attrs' => array(
					'placeholder' => __( 'Please select a order...', 'advanced-local-pickup-pro' ),
		...
		$wp_customize->add_control( new WPLP_Skyrocket_Dropdown_Select_Custom_Control( $wp_customize, 'wclp_order_status_email_type',
			array(
				'label' => __( 'Email Type', 'advanced-local-pickup-pro' ),
				'description' => '',
				'section' => 'customer_email_notifications',
				'input_attrs' => array(
					'placeholder' => __( 'Select email type', 'advanced-local-pickup-pro' ),
					'class' => 'preview_email_type',
				),
				'choices' => array(
					'ready_pickup' => __( 'Ready for Pickup', 'advanced-local-pickup-pro' ),
					'picked_up' => __( 'Picked Up', 'advanced-local-pickup-pro' ),
				),
			)
		) );							
		...
		$wp_customize->add_control( 'customizer_ready_pickup_order_settings_enabled',
			array(
				'label' => __( 'Enable Ready for Pickup order status email', 'advanced-local-pickup-pro' ),
		...
		$wp_customize->add_control( 'woocommerce_customer_ready_pickup_order_settings[subject]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wclp_ready_pickup_email_subject'], 'advanced-local-pickup-pro' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		);
		...
		$wp_customize->add_control( 'woocommerce_customer_ready_pickup_order_settings[heading]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wclp_ready_pickup_email_heading'], 'advanced-local-pickup-pro' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		);
		...
		$wp_customize->add_control( new WPLP_Skyrocket_TinyMCE_Custom_control( $wp_customize, 'woocommerce_customer_ready_pickup_order_settings[additional_content]',
			array(
				...
				'input_attrs' => array(
					...
					'mediaButtons' => true,
					'placeholder' => __( $this->defaults['wclp_ready_pickup_email_content'], 'advanced-local-pickup-pro' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		) );	
